...
//////////////////////////////////////////////////////////////////////////////////
void Output::PrintMsg(string msg , int MsgX , int MsgY ) const
{
...
void Output::DrawLabel(const GraphicsInfo& r_GfxInfo, const string& text) const
{
	// Use message color for now; adjust font/size as needed
	pWind->SetFont(14, BOLD | ITALICIZED, BY_NAME, "Arial");
	pWind->SetPen(UI.MsgColor);
	// DrawString expects absolute coordinates (x, y)
